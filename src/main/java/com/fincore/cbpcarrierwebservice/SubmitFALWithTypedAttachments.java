 ...
 *         &lt;element name="files" type="{http://fincore.com/CBPCarrierWebService/entities}ArrayOfTypedFile" minOccurs="0"/&gt;
 *       &lt;/sequence&gt;
 *     &lt;/restriction&gt;
 *   &lt;/complexContent&gt;
 * &lt;/complexType&gt;
...
@XmlRootElement(name = "SubmitFALWithTypedAttachments")
public class SubmitFALWithTypedAttachments {
    ...
    protected JAXBElement<ArrayOfTypedFile> files;
     ...
     * @return
     *     possible object is
     *     {@link JAXBElement }{@code <}{@link ArrayOfTypedFile }{@code >}
     *     
     */
    public JAXBElement<ArrayOfTypedFile> getFiles() {
        return files;
    }
     ...
     *     
     */
    public void setFiles(JAXBElement<ArrayOfTypedFile> value) {
        this.files = value;
    }
