...
public class VersionResponse {
    ...
    @XmlElementRef(name = "VersionResult", namespace = "http://fincore.com/CBPCarrierWebService/", type = JAXBElement.class, required = false)
    protected JAXBElement<String> versionResult;
     ...
     *     
     */
    public JAXBElement<String> getVersionResult() {
     ...
     *     
     */
    public void setVersionResult(JAXBElement<String> value) {
